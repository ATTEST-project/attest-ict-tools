...
def main_screening(mpc, gen_status, line_status, multiplier, cicost,
                   penalty_cost, peak_Pd, peak_Qd, ci_catalogue, cont_list, Q_load_correction, use_load_data_update,add_load_data_case_name, output_directory_path, EV_data_file_path):
    ''' Time point '''
