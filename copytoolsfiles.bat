...
xcopy /E /I /H /Y .\T42 %DEST_TOOLS_ROOT_PATH%\WP4\T42
xcopy /E /I /H /Y .\T44V3 %DEST_TOOLS_ROOT_PATH%\WP4\T44V3
xcopy /E /I /H /Y .\T44V3_DEMO %DEST_TOOLS_ROOT_PATH%\WP4\T44V3_DEMO
xcopy /E /I /H /Y .\T45_FINAL %DEST_TOOLS_ROOT_PATH%\WP4\T45_FINAL
