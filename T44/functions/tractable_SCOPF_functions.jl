...
println("")
if termination_status(model_name)==OPTIMAL || termination_status(model_name)==LOCALLY_SOLVED  || termination_status(model_name)==ALMOST_OPTIMAL || termination_status(model_name)==ALMOST_LOCALLY_SOLVED
