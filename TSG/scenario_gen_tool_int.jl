...
nScenarios  = get(parameters, "nsc", 10)
v_cut_in    = 1.5   # (m/s)
v_cut_out   = 22    # (m/s)
v_rat       = 10    # (m/s)
p_rat       = 1.0   # (kW)
...
# ods_write("scenario_gen.ods",Dict(("probabilities",1,1)=>data))
