...
source_files=ARGS[1]
#WP6 replaced by -  destination_files="data\\network_data.xlsx"
#WP6 take the destination_file variable from the ARGS
destination_files=ARGS[2]
    ...
    BaseMVA_df = DataFrames.DataFrame(BaseMVA = [network_data["baseMVA"]])
...
println("Writing network XLSX file")
    ...
    XLSX.writetable(destination_files,
        ...
        BaseMVA     =( collect(DataFrames.eachcol(BaseMVA_df)), DataFrames.names(BaseMVA_df) ),
