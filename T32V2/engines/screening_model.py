...
def main_screening(input_dir,mpc,multiplier,cicost, penalty_cost, peak_Pd, cont_list,NoYear,gen_status, line_status, add_load_data, add_load_data_case_name,EV_data_file_name):
    ''' Time point '''
        ...
        for xsc in range(len(multiplier[xy])):
            ...
            if add_load_data == 1:
                ...
                if year_name[xy] != 2020:
                    #WP6 added as a parameter to prepare_invest_model
...
def run_main_screening(input_dir, output_dir,ods_file_name, xlsx_file_name, country, test_case, peak_hour, NoYear, add_load_data, add_load_data_case_name,EV_data_file_name):
    ...
    ''' Outputs '''
    interv_dict = main_screening(input_dir, mpc, multiplier_bus ,cicost, penalty_cost ,peak_Pd, cont_list,NoYear,gen_status, line_status, add_load_data, add_load_data_case_name,EV_data_file_name)
