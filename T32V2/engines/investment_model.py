...
def run_main_investment(input_dir, output_dir, ods_file_name, xlsx_file_name, country, test_case, peak_hour, NoYear, run_all, add_load_data,add_load_data_case_name,EV_data_file_name):
    start = time.time()
