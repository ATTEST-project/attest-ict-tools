...
def read_input_data(input_dir, ods_file_name, xlsx_file_name,country, test_case ):
    ...
    #WP6 debug
    print('++ input file directory: ' + str(input_file_folder))
    print('++ matpower file name: ' + str(file_name))
    ...
    #WP6 debug
    print('++ json converted from matpower file: ' + str(filepath))
    ...
    #WP6 debug
    print('++ ods_file_path:' + str(ods_file_path))
    ...
    #WP6 debug
    print('++ intervention file name: ' + str(ods_file_path))
