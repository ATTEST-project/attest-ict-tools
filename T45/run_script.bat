...
::T4.4 data
set flexibity_devices_states_file=data\procured_flexibility_PT_2050_wf.xlsx
set DA_curtailment_file=data\PT_2050_wf_Normal.xlsx

::State estimation in form of T4.3
set state_estimation_csv_file=data\state_estimation.csv
