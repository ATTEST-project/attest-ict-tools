function sql_opf_model(vol_nodes_mag_pf,vol_nodes_theta_pf,nSc,nTP,nBus,nNcurt_gen,nCurt_gen,nTrsf,nStr_active,nFl,nd_fl,flex_apc,flex_oltc,flex_adpf,flex_str,flex_fl,str_bin,fl_bin,rdata_buses,nLines,trsf_fict_nodes,tap_ratio_range,
    ...
    ratioGap     = 0
    sql_itr      = 1
    feasb_status = 2      # feasb_status = 1 OK; otherwise the OPF model is not solved
    lin_itr_old  = deepcopy(lin_itr)
    infsb_model  = 0

    while s_inj_error_rel>s_error_tol && sql_itr<=sql_itr_max
        display("SQL_iteration: $sql_itr")
        println(" ")
        if sql_itr==1
        ...
        if s_inj_error_rel>s_error_tol && sql_itr<=sql_itr_max
            feasb_status = 2
        end
        while feasb_status != 1
...
##--------------------- Solving the Optimization Model---------------------#####
            ...
            elseif term_status == 1
                ...
                (vm_ac,va_ac,vm_plr,va_plr,vm_min,vm_max,gen_Ncurt_P,gen_Ncurt_Q,gen_Curt_P_sc,gen_Curt_P_gen,total_p_curt,fl_inc_sc,fl_dec_sc,fl_inc_nd,fl_dec_nd,p_ch_nd,p_dis_nd,soc_nd,p_strg_nd,trsf_ratio,gen_Curt_Q,br_crnt_pu,br_crnt_si,br_pwr_ij_pu,br_pwr_ij_SI,br_crnt_ij_pu_ex,br_crnt_ij_SI_ex,br_pwr_ij_pu_ex,br_pwr_ij_SI_ex,app_err,
                p_inj,q_inj,p_imp_td,q_imp_td,str_bv,fl_bv,oltc_bv,oltc_aux_bv,ratio_sql,p_inj_nl,q_inj_nl,avg_gen_curt,avg_str_chr,avg_str_dch,avg_str_soc,avg_fl_od,avg_fl_ud,avg_tratio,oltc_ratio_tmp)=
                opf_model_solution(term_status,v_mag,v_ang,Pg,Qg,Pg_curt,p_ch,p_dis,soc,p_strg,p_fl_inc,p_fl_dec,tratio,bin_ch,bin_fl,bin_tap,aux_tap,flex_str,flex_fl,flex_oltc,flex_adpf,nNcurt_gen,nCurt_gen,nFl,nTrsf,nLines,nw_lines,node_data,rdata_buses,yij_line,pg_max,pgen_tol,qgen_tol,p_tol,q_tol,prob_scs,nTP,nSc,rcvr_branch,
                rcvr_inj,rcvr_tso_dso,i_curt_gens,sbase,v_mag_int,v_ang_int,Ibase,dLines,idx_slack_bus_pf,trsf_fict_nodes,vm_ac,va_ac,vm_plr,va_plr,vm_min,vm_max,gen_Ncurt_P,gen_Ncurt_Q,gen_Curt_P_sc,gen_Curt_P_gen,total_p_curt,fl_inc_sc,fl_dec_sc,fl_inc_nd,fl_dec_nd,p_ch_nd,p_dis_nd,soc_nd,p_strg_nd,trsf_ratio,dgpf,
                gen_Curt_Q,br_crnt_pu,br_crnt_si,br_pwr_ij_pu,br_pwr_ij_SI,br_crnt_ij_pu_ex,br_crnt_ij_SI_ex,br_pwr_ij_pu_ex,br_pwr_ij_SI_ex,app_err,p_inj,q_inj,p_imp_td,q_imp_td,str_bv,fl_bv,oltc_bv,oltc_aux_bv,ratio_sql,p_inj_nl,q_inj_nl,avg_gen_curt,avg_str_chr,avg_str_dch,avg_str_soc,avg_fl_od,avg_fl_ud,avg_tratio,oltc_ratio,dg_pf_value,dg_pf,Qg_curt,rdata_trsf,nTrsf_s1,nw_trsf,n_tap)
...
return vm_ac,va_ac,vm_plr,va_plr,vm_min,vm_max,gen_Ncurt_P,gen_Ncurt_Q,gen_Curt_P_sc,gen_Curt_P_gen,total_p_curt,fl_inc_sc,fl_dec_sc,fl_inc_nd,fl_dec_nd,p_ch_nd,p_dis_nd,soc_nd,p_strg_nd,trsf_ratio,
       gen_Curt_Q,br_crnt_pu,br_crnt_si,br_pwr_ij_pu,br_pwr_ij_SI,br_crnt_ij_pu_ex,br_crnt_ij_SI_ex,br_pwr_ij_pu_ex,br_pwr_ij_SI_ex,app_err,p_inj,q_inj,p_inj_nl,q_inj_nl,p_imp_td,q_imp_td,str_bv,fl_bv,oltc_bv,oltc_aux_bv,ratio_sql,v_mag_int,v_ang_int,
       max_err_per_bus,norm_s_err_max_power,p_err_max_power,q_err_max_power,avg_err_per_bus,norm_s_err_avg,p_err_avg,q_err_avg,rel_max_error,rel_avg_error,sql_itr,sql_obj,sql_time,avg_gen_curt,
       avg_str_chr,avg_str_dch,avg_str_soc,avg_fl_od,avg_fl_ud,avg_tratio,oltc_ratio,infsb_model,term_status
end
