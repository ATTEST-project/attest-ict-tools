...
from pyensys.cases import test_pyene, test_pyeneE, test_pyeneN, test_pyeneAC, \
    ...
    attest_invest_path, attest_invest_wp6
...
@cli.command('run-dist_invest_wp6')
@click.option('--input_file', default='', help='input json file')
def pyensys_ATTEST_Distribution_wp6(**kwargs):
    ''' Call ATTEST's distribution network planning tool - wp6 version: inputs from a json file'''
    attest_invest_wp6(kwargs)
